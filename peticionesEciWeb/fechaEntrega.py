...
def fechaEntrega():
    ...
    try:
        ...
        cx["cur"].execute("SELECT v.idweb as idweb, v.id AS id, v.datosventa AS datosventa FROM ew_ventaseciweb v INNER JOIN idl_ecommerce e ON v.idtpv_comanda = e.idtpv_comanda WHERE v.estado = 'SHIPPED' AND v.envioinformado = TRUE AND v.fechaentregainformada = FALSE AND e.fechamagento < CURRENT_DATE")
